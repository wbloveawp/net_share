...
--*/
{
    ...
    DbgPrint("NdisProtOpenAdapterComplete===============================================>\n");
...
--*/
{
    ...
    DbgPrint("NdisProtUnbindAdapter===============================================>\n");
    pOpenContext = (PNDISPROT_OPEN_CONTEXT)ProtocolBindingContext;
    NPROT_STRUCT_ASSERT(pOpenContext, oc);
...
--*/
{
    ...
    pOpenContext = (PNDISPROT_OPEN_CONTEXT)ProtocolBindingContext;
	DbgPrint("NdisProtPnPEventHandler===============================================>\n");
...
--*/
{
	DbgPrint("NdisProtProtocolUnloadHandler===============================================>\n");
...
--*/
{
	...
	DbgPrint("ndisprotCreateBinding===============================================>\n");
...
--*/
{
	...
	DbgPrint("ndisprotShutdownBinding===============================================>\n");
    do
    {
        NPROT_ACQUIRE_LOCK(&pOpenContext->Lock);
...
--*/
{
	...
	{
		NdisFreeMemory(Globals.net_ip_filter, Globals.net_ip_filter_len, 0);
	}
		
	Globals.net_ip_filter = NULL ;
